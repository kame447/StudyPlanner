...
const result = spawnSync(
  process.execPath,
  ['./node_modules/vitest/vitest.mjs', '--config', 'vite.config.mjs', 'run', ...focusedTests],
  {
    cwd: process.cwd(),
    encoding: 'utf8',
    env: process.env,
...
writeFileSync('dist/index.html', '<!doctype html><meta charset="utf-8"><title>focused tests</title>');
