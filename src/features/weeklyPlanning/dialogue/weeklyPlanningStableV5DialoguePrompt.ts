...
export function createWeeklyPlanningStableV5DialoguePrompt(
  ...
  const userPrompt = JSON.stringify({
    ...
    request: [
      ...
      'groundingAcknowledgementはACKの構造契約です。required_before_resumeではnull禁止で、ackしたacceptedFactsのfactIdと短いACK本文を入れ、最終textはそのACK本文から始めてください。recommendedでは必要な場合だけ使い、noneではnullにしてください。',
