...
export interface WeeklyPlanningTurnTraceSideEffectServices {
...
const defaultTraceServices: WeeklyPlanningTurnTraceSideEffectServices = {
...
function stableV5PlanningRange(
  ...
  services: WeeklyPlanningTurnTraceSideEffectServices,
) {
