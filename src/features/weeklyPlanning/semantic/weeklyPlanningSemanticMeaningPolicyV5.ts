export function createWeeklyPlanningSemanticMeaningPolicyV5(): string {
  return [
    ...
    'A concern requires explicit evidence of difficulty, weakness, worry, low confidence, being behind, or a motivation problem; amount, frequency, duration, or workload size alone is not concern evidence and must not imply priority.',
