...
const AI_OWNERSHIP_INSTRUCTION_V5 = [
  ...
  'For an existingPublicId, preserve the partner-specific label already established with this user in publicStateSummary/recentConversation. Reuse the established title/contextLabel unless the current userText explicitly renames it; do not expand an abbreviation or nickname into a more formal name on your own.',
