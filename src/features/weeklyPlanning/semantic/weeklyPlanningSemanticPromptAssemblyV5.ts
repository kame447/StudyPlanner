...
const SEMANTIC_DELTA_CONTEXT_INSTRUCTION_V5 = [
  ...
  'registeredMaterials: resolve aliases and saved progress from known context; never replay unchanged saved facts. If the user explicitly selects all remaining work for one uniquely matched material, emit only that new remaining workload using the saved remainingUnits/unit as contextual grounding.',
