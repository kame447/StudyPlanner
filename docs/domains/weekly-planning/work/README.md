...
Issue #305 holds the OpenRouter focused-authorization implementation design, rollout gates, evaluation conditions and current checkpoint. Keep that detail in the Issue rather than copying it into a second provider or migration specification. Provider integration, security and shared telemetry continue to consume #187, #152 and #213 respectively. The runtime defaults to off; implementation and mock verification do not establish real-API validation or production rollout.
