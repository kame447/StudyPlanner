...
Issue-only active scopes such as #52, #128, #152, #269 and #270 do not need duplicate task Markdown unless durable technical detail/checkpoints exceed what should live in the Issue.
