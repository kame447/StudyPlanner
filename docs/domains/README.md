...
- [`external-integrations/`](external-integrations/README.md): external provider/adapter boundaries, usage conditions, shared metadata caches and failure isolation for imported data; book material metadata requirements live in [`spec/material-metadata.md`](external-integrations/spec/material-metadata.md)
