...
最終採否は、最終 head に対する全 test suite、TypeScript と production build、diff check の成功、unresolved review thread 0 件、draft 解除後の mergeable=true を満たした場合に採用可とする。これらを満たさない場合は採用不可へ戻す。
